...
if (isset($_POST['removeEmpSQL'])) {
	$id = mysqli_real_escape_string($connection, $_POST['emp']);
...
<nav id="sidenav">
    ...
    <div class="bContainer">
        <div class="removePer">
            ...
            <div class="removePerForm">
	<!--Asks admin for information on employee to add into database.-->
    <form action ='removeEmp.php' method='POST'>
    <div class="one">
		<label for="emp">Employee ID: </label><input type='text' id='emp' size="54">
    ...
    <div class="sButton">
        <button class="bttn" type='submit' name='removeEmpSQL' id='removeEmpSQL'>Remove Employee</button>
	</div>
    </form>
    </div>
</div>
