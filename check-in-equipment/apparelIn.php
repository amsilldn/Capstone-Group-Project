<?php
	...
	$apparel = $_SESSION['checkin_apparel']; //take the session variable to know what they selected on checkout.php
	...
	if (isset($_POST['rCheckOut'])) {
		...
		$update = "UPDATE checkoutLog SET checkinDate = NOW() WHERE equipID = '" . $equipid . "' AND empID ='" . $emp . "'"; 
		...
		$get_equip = mysqli_query($connection, "SELECT equipID FROM equipment WHERE equipID = '" . $equipid . "'");
...
<nav id="sidenav">
    ...
    <div class="bContainer">
        <div class="aInForm">
            <div class="aInButtons">
                <form action="apparelIn.php" method="POST">
				<h2> <?php echo $apparel; ?> In</h2>
				...
				<div class="one">
                    ...
                    <div class="sButton">
                    <button class="bttn" type="submit" name="rCheckOut" id="rCheckOut">Check In</button>
                    </div>
