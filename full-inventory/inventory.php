...
?>
<div class="container">
<form method='post' action='downloadInventory.php'>
...
$sql = mysqli_query($connection,"Select distinct e.equipID, e.type, e.size, e.quantityOwned From equipment as e order by equipID");
$user_arr = array(array('Equipment ID', 'Equipment Type', 'Size', 'Quantity Owned'));

while($record = mysqli_fetch_assoc($sql)) {
$user_arr[] = array($record['equipID'], $record['type'], $record['size'], $record['quantityOwned']);
	echo "<tr><td>" . $record['equipID'] . "</td><td>" . $record['type'] . "</td><td>" . $record['size'] . "</td><td>" . $record['quantityOwned'] . "</td></tr>";	
}
?>
</table>
