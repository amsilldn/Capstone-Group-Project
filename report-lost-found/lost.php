<?php
	...
	if ($_POST['selection'] == ''){ //if nothing is clicked
		//echo '';
	} 
	else {
		$_SESSION['apparel'] = $_POST['selection']; //create session variable to track which piece of apparel they selected
		header("location:lostForm.php");//redirect to apparel checkout page
