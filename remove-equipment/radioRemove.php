        ...
        <div class="rInForm">
            ...
            <div class="rInButtons">
                <form action="#" method="POST">
                    ...
                    <div class="sButton">
                    <button class="bttn" type="submit" name="rRemove" value="rRemove">Remove Equipment</button>
                </div>
                </form>
            </div>
...
if ($id =='') {
	...
	//Remove Radio #XX
	$sql="DELETE FROM equipment WHERE (equipID = '" . $id . "' AND type = 'Radio')";
					
	if ($conn->query($sql) === TRUE) {
		echo "Radio #" . $id . " was removed from the database.";
	} 
	else {
