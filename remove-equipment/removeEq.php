<?php
	...
	if ($_POST['selection'] == "Radio"){ //If Radio is clicked
		header("location:radioRemove.php");//redirect to radio checkout page
	} 
	else if ($_POST['selection'] == ''){ //if nothing is clicked
		//echo '';
	} 
	else {
		$_SESSION['checkout_apparel'] = $_POST['selection']; //create session variable to track which piece of apparel they selected
		header("location:apparelRemove.php");//redirect to apparel checkout page
