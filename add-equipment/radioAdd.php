        ...
        <div class="rInForm">
            ...
            <div class="rInButtons">
                ...
                <div class="one"
                    ...
                    <div class="sButton">
                    <button class="bttn" type="submit" name="rAdd" value="rAdd">Add Equipment</button>
                    </div>
                </form>
            </div>
        </div>
...
if ($id=='') {
	$check = '<b>Please fill out all fields.</b>'; //traces for debugging: <p>ID:' . $id . '<p>Name:' . $name . '<p>Size:' . $size . '<p>Quantity:' . $quan . "."
}

else {
	$sql="INSERT INTO equipment VALUES ('" . $id . "', 'Radio', 'NA', '1')";
						
	if ($conn->query($sql) === TRUE) {
		echo "Radio " . $id . " was added to the database.";
	} 
	else {
